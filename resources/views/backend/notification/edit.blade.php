		                            ...
		                            <div class="col-sm-12">
		                                ...
		                                <div class="form-group" id="edit-slug-box">
											...
											<span id="sample-permalink">
												<a class="permalink" target="_blank" href="{{ route('home.notification-single_vi', $data->slug) }}">
													<span class="default-slug">
														{{ asset('vi') }}/thong-bao/<span id="editable-post-name">{{ $data->slug }}</span>
													</span>
												</a>
											</span>
		                                </div>
		                        ...
		                        <div class="row">
		                            <div class="col-sm-12">
		                                ...
		                                <div class="form-group" id="edit-slug-box">
		                                    <label class="control-label required" for="current-slug" aria-required="true">Đường dẫn:</label>
											<span id="sample-permalink">
												<a class="permalink" target="_blank" href="{{ route('home.notification-single_en', $data->slug_en) }}">
													<span class="default-slug">
														{{ asset('en') }}/notification/<span id="editable-post-name">{{ $data->slug_en }}</span>
													</span>
												</a>
											</span>
		                                </div>
