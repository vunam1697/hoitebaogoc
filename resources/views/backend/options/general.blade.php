			               		...
			               		<div class="row">
									<div class="col-sm-6">
										...
										<div class="form-group">
											...
											<input type="text" name="content[email_1]" class="form-control" value="{{ @$content->email_1 }}">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
										...
										<div class="form-group">
											<label for="">Email</label>
											<input type="text" name="content[email_2]" class="form-control" value="{{ @$content->email_2 }}">
										</div>
									</div>
			               			<div class="col-sm-12">
										<div class="form-group">
