               	...
               	<form action="{{ route('pages.build.post') }}" method="POST">
					...
					<div class="nav-tabs-custom">
				        <ul class="nav nav-tabs">
				            <li class="active">
				            	<a href="#content-1" data-toggle="tab" aria-expanded="true">Tế bào gốc là gì</a>
							</li>
							<li class="">
				            	<a href="#content-2" data-toggle="tab" aria-expanded="true">Các loại tế bào gốc</a>
							</li>
							<li class="">
				            	<a href="#content-3" data-toggle="tab" aria-expanded="true">Niche tế bào gốc</a>
							</li>
							<li class="">
				            	<a href="#content-4" data-toggle="tab" aria-expanded="true">Lịch sử tế bào gốc</a>
							</li>
							<li class="">
				            	<a href="#content-5" data-toggle="tab" aria-expanded="true">Ngân hàng tế bào gốc</a>
							</li>
							<li class="">
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										...
										<input type="text" name="content[content1][title]" class="form-control" value="{{ @$content->content1->title }}">
									</div>
								</div>
								<div class="col-sm-10">
									<div class="form-group">
										<label for="">Nội dung</label>
										<textarea name="content[content1][content]" class="content">{!! @$content->content1->content !!}</textarea>
									</div>
								</div>
								<div class="col-sm-2">
									<div class="form-group">
										...
										<div class="image">
											<div class="image__thumbnail">
												<img src="{{ @$content->content1->image ?  @$content->content1->image : __IMAGE_DEFAULT__ }}"  
												data-init="{{ __IMAGE_DEFAULT__ }}">
												<a href="javascript:void(0)" class="image__delete" onclick="urlFileDelete(this)">
												 <i class="fa fa-times"></i></a>
												<input type="hidden" value="{{ @$content->content1->image }}" name="content[content1][image]"  />
						...
						<div class="tab-pane" id="content-5">
							<div class="row">
								<div class="col-sm-12">
                                    ...
                                    <div class="form-group">
										<label for="">Nội dung</label>
										<textarea name="content[content5][content]" class="content">{!! @$content->content5->content !!}</textarea>
									</div>
								</div>
							</div>
						</div>
