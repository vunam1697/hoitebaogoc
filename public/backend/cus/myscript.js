...
jQuery(document).ready(function($) {
    ...
    // EN
    $('#change_slug_en').click(function(event) {
        $('#change_slug_en').hide();
        $('#btn-ok-en').show();
        $('.cancel.button-link-en').show();
        changeInputEn();
    });

    $('.cancel.button-link-en').click(function(event) {
        $('#change_slug_en').show();
        $('#btn-ok-en').hide();
...
// EN
function changeInputEn() {
    var content = $('#current-slug-en').val();
    var base = $('#baseUrlEn').val();
    var html = '<span class="default-slug-en">' + base + '/<span id="editable-post-name-en"><input type="text" id="new-post-slug-en" value="' + content + '"></span></span>';
    $('#sample-permalink-en').html(html);
}

function cancelInputEn(slug = null) {

    var current_slug;
    if (slug == null) {
        current_slug = $('#current-slug-en').val();
    } else {
        current_slug = slug;
    }
    var base = $('#baseUrlEn').val();
    var html = '<a class="permalink" target="_blank" href="' + base + '/' + current_slug + '"><span class="default-slug-en">' + base + '/<span id="editable-post-name-en">' + current_slug + '</span></span></a>';
    $('#sample-permalink-en').html(html);
}